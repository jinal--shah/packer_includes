...
#
# 00030-create_metrics_remote_info.sh 
#
# Will generate a file under /etc/eurostar/metrics_remote_info
...
INFO_FILE="/etc/eurostar/metrics_remote_info"
FAILED_VALIDATION=''
TIMESTAMP="$(date +'%Y-%m-%d %H:%M:%S')"
MARKER="METRICS_REMOTE_INFO GENERATED BY"
